...
/// <summary>
///     Provides pre-configured hint slots for common in-game UI scenarios such as item, map, role, and other
...
public class CommonHint : IDisposable
{
    ...
    public void ShowItemHint(string itemName, float? time = null)
    {
        ShowItemHint(itemName, [], time ?? Config.ShortItemHintDisplayTime);
    }
    ...
    {
        ShowItemHint(itemName, [description], time ?? Config.ItemHintDisplayTime);
    }
    ...
    /// <param name="time">The duration in seconds to show the hint.</param>
    public void ShowMapHint(string roomName, float? time = null)
    {
        ShowMapHint(roomName, [], time ?? Config.ShortMapHintDisplayTime);
    }
    ...
    {
        ShowMapHint(roomName, [description], time ?? Config.MapHintDisplayTime);
    }
    ...
    /// <param name="time">The duration in seconds to show the hint.</param>
    public void ShowRoleHint(string roleName, float? time = null)
    {
        ShowRoleHint(roleName, [], time ?? Config.ShortRoleHintDisplayTime);
    }
    ...
    {
        ShowRoleHint(roleName, [description], time ?? Config.RoleHintDisplayTime);
    }
    ...
    /// <param name="time">The duration in seconds to show the hint.</param>
    public void ShowOtherHint(string message, float? time = null)
    {
        ShowOtherHint([message], time ?? Config.OtherHintDisplayTime);
    }
