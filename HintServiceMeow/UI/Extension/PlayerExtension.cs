...
public static class PlayerExtension
{
    ...
    public static PlayerUI GetPlayerUi(this Player player)
    {
    ...
    public static void ShowItemHint(this Player player, string itemName)
    {
        PlayerUI.Get(player).CommonHint.ShowItemHint(itemName);
    }
    ...
    public static void ShowItemHint(this Player player, string itemName, float time)
    {
        PlayerUI.Get(player).CommonHint.ShowItemHint(itemName, [], time);
    }
    ...
    public static void ShowItemHint(this Player player, string itemName, string description)
    {
        PlayerUI.Get(player).CommonHint.ShowItemHint(itemName, [description]);
    }
    ...
    /// <param name="description">A description line shown below the item name.</param>
    /// <param name="time">The duration in seconds to show the hint.</param>
    public static void ShowItemHint(this Player player, string itemName, string description, float time)
    {
        PlayerUI.Get(player).CommonHint.ShowItemHint(itemName, [description], time);
    }
    ...
    public static void ShowMapHint(this Player player, string roomName)
    {
        PlayerUI.Get(player).CommonHint.ShowMapHint(roomName);
    }
    ...
    /// <param name="roomName">The name of the room to display.</param>
    /// <param name="time">The duration in seconds to show the hint.</param>
    public static void ShowMapHint(this Player player, string roomName, float time)
    {
        PlayerUI.Get(player).CommonHint.ShowMapHint(roomName, [], time);
    }
    ...
    public static void ShowMapHint(this Player player, string roomName, string description)
    {
        PlayerUI.Get(player).CommonHint.ShowMapHint(roomName, [description]);
    }
    ...
    /// <param name="description">A description line shown below the room name.</param>
    /// <param name="time">The duration in seconds to show the hint.</param>
    public static void ShowMapHint(this Player player, string roomName, string description, float time)
    {
        PlayerUI.Get(player).CommonHint.ShowMapHint(roomName, [description], time);
    }
    ...
    public static void ShowRoleHint(this Player player, string roleName)
    {
        PlayerUI.Get(player).CommonHint.ShowRoleHint(roleName);
    }
    ...
    /// <param name="roleName">The name of the role to display.</param>
    /// <param name="time">The duration in seconds to show the hint.</param>
    public static void ShowRoleHint(this Player player, string roleName, float time)
    {
        PlayerUI.Get(player).CommonHint.ShowRoleHint(roleName, [], time);
    }
    ...
    public static void ShowRoleHint(this Player player, string roleName, string description)
    {
        PlayerUI.Get(player).CommonHint.ShowRoleHint(roleName, [description]);
    }
    ...
    /// <param name="description">A description line shown below the role name.</param>
    /// <param name="time">The duration in seconds to show the hint.</param>
    public static void ShowRoleHint(this Player player, string roleName, string description, float time)
    {
        PlayerUI.Get(player).CommonHint.ShowRoleHint(roleName, [description], time);
    }
    ...
    public static void ShowOtherHint(this Player player, string messages)
    {
        PlayerUI.Get(player).CommonHint.ShowOtherHint(messages);
    }
    ...
    /// <param name="messages">The message to display.</param>
    /// <param name="time">The duration in seconds to show the hint.</param>
    public static void ShowOtherHint(this Player player, string messages, float time)
    {
        PlayerUI.Get(player).CommonHint.ShowOtherHint([messages], time);
    }

    /// <summary>
    ///     Displays multiple general-purpose hint messages, each using the configured display time scaled by the number of
    ///     messages.
    /// </summary>
    /// <param name="player">The LabAPI player to show the hint to.</param>
