...
public sealed class FontWeightTag : RichTag
{
    ...
    /// </summary>
    public static readonly FontWeightTag Normal = new("400");

    /// <summary>
    ///     Bold weight (700). Syntax: <c>&lt;font-weight="700"&gt;text&lt;/font-weight&gt;</c>.
    /// </summary>
    public static readonly FontWeightTag Bold = new("700");

    private readonly string weight;

    /// <inheritdoc />
    public override string OpenTag => $"<font-weight=\"{weight}\">";
    ...
    /// </param>
    /// <returns>A new <see cref="FontWeightTag" /> with the specified weight value.</returns>
