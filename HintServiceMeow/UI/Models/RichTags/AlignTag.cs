...
public sealed class AlignTag : RichTag
{
    ...
    /// </summary>
    public static readonly AlignTag Justified = new("justified");

    /// <summary>
    ///     Similar to justified, but also justifies the last line of a paragraph.
    ///     Syntax: <c>&lt;align="flush"&gt;text&lt;/align&gt;</c>.
    /// </summary>
    public static readonly AlignTag Flush = new("flush");

    private readonly string value;

    /// <inheritdoc />
    public override string OpenTag => $"<align=\"{value}\">";
