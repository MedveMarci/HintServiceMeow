...
public static class WrapModeExtension
{
    ...
    /// </summary>
    /// <remarks>
    ///     If the value of rm is WrapMode.ClampForever, the method returns
    ///     HsmWrapMode.Once.
    /// </remarks>
    ...
    public static HsmWrapMode ToHsmWrapMode(this WrapMode rm)
    {
        return rm switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(rm), $"Unexpected WrapMode value: {rm}")
        };
    }
    ...
    public static WrapMode ToUnityWrapMode(this HsmWrapMode rm)
    {
        return rm switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(rm), $"Unexpected HsmWrapMode value: {rm}")
        };
    }
}