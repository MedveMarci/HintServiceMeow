...
public static class PlayerExtension
{
    ...
    public static PlayerDisplay GetPlayerDisplay(this Player player)
    {
    ...
    public static void AddHint(this Player player, AbstractHint hint)
    {
        PlayerDisplay.Get(player).InternalAddHint(Assembly.GetCallingAssembly().FullName, hint);
    }

    /// <summary>
    ///     Adds multiple hints to the specified LabApi player's display using the calling assembly as the owner.
    /// </summary>
    /// <param name="player">The LabApi player to show the hint on.</param>
    /// <param name="hints">The hints to add.</param>
    public static void AddHint(this Player player, IEnumerable<AbstractHint>? hints)
    {
        if (hints is null)
            return;
    ...
    /// <param name="player">The LabApi player to show the hint on.</param>
    /// <param name="hints">The hints to add.</param>
    public static void AddHint(this Player player, params AbstractHint[]? hints)
    {
    ...
    public static void AddHint(this Player player, AbstractHint? hint, string groupName)
    {
        if (hint is null)
            return;
    ...
    public static void ShowHint(this Player player, AbstractHint hint, float duration = 7f, AfterShowAction afterShow = AfterShowAction.Remove)
    {
        if (hint is null)
            return;
    ...
    /// <summary>
    ///     Adds a collection of hints to the player's display and schedules their removal or hiding after the specified
    ///     duration.
    /// </summary>
    /// <param name="player">The LabApi player to show the hint on.</param>
    ...
    /// <param name="duration">The duration in seconds before the after-show action is applied.</param>
    /// <param name="afterShow">The action to take after the duration elapses.</param>
    public static void ShowHint(this Player player, IEnumerable<AbstractHint> hints, float duration = 7f, AfterShowAction afterShow = AfterShowAction.Remove)
    {
        if (hints is null)
            return;
    ...
    public static void RemoveHint(this Player player, AbstractHint hint)
    {
        PlayerDisplay.Get(player).InternalRemoveHint(Assembly.GetCallingAssembly().FullName, hint);
    }

    /// <summary>
    ///     Removes a list of hints from the specified LabApi player's display.
    /// </summary>
    /// <param name="player">The LabApi player whose hint is removed.</param>
    /// <param name="hints">The hints to remove.</param>
    public static void RemoveHint(this Player player, IEnumerable<AbstractHint>? hints)
    {
        if (hints is null)
            return;
    ...
    /// <param name="player">The LabApi player whose hint is removed.</param>
    /// <param name="hints">The hints to remove.</param>
    public static void RemoveHint(this Player player, params AbstractHint[]? hints)
    {
        if (hints is null || hints.Length == 0)
            return;
    ...
    public static void RemoveHint(this Player player, AbstractHint? hint, string groupName)
    {
        if (hint is null)
            return;
    ...
    public static void RemoveHint(this Player player, Guid id)
    {
        PlayerDisplay.Get(player).InternalRemoveHint(Assembly.GetCallingAssembly().FullName, id);
    }
    ...
    /// </summary>
    /// <param name="player">The LabApi player whose hint is cleared.</param>
    public static void ClearHint(this Player player)
    {
    ...
    /// </summary>
    /// <param name="player">The LabApi player whose hint is acquired from.</param>
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="id" /> is <see langword="null" />.</exception>
    /// <exception cref="ArgumentException">Thrown when <paramref name="id" /> is an empty string.</exception>
    public static AbstractHint? GetHint(this Player player, string? id)
    {
        if (string.IsNullOrEmpty(id))
    ...
    /// <returns>The matching <see cref="AbstractHint" />, or <see langword="null" /> if none is found.</returns>
    public static AbstractHint? GetHint(this Player player, Guid guid)
    {
        return PlayerDisplay.Get(player).InternalGetHints(Assembly.GetCallingAssembly().FullName, x => x.Guid == guid).FirstOrDefault();
    }

    /// <summary>
    ///     Returns all hints registered by the calling assembly that match the specified identifier.
    /// </summary>
    /// <param name="player">The LabApi player whose hints is acquired from.</param>
    /// <param name="id">The identifier to filter hints by.</param>
    /// <returns>An enumerable sequence of matching hints.</returns>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="id" /> is <see langword="null" />.</exception>
    /// <exception cref="ArgumentException">Thrown when <paramref name="id" /> is an empty string.</exception>
    public static IEnumerable<AbstractHint> GetHints(this Player player, string id)
    {
        if (string.IsNullOrEmpty(id))
    ...
    public static IEnumerable<AbstractHint> GetHints(this Player player)
    {
        return PlayerDisplay.Get(player).InternalGetHints(Assembly.GetCallingAssembly().FullName);
    }

    /// <summary>
    ///     Determines whether any hint registered by the calling assembly has the specified identifier.
    /// </summary>
    /// <param name="player">The LabApi player whose hint is checked.</param>
    /// <param name="id">The identifier to search for.</param>
    /// <returns><see langword="true" /> if a matching hint exists; otherwise <see langword="false" />.</returns>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="id" /> is <see langword="null" />.</exception>
    /// <exception cref="ArgumentException">Thrown when <paramref name="id" /> is an empty string.</exception>
    public static bool HasHint(this Player player, string id)
    {
        if (string.IsNullOrEmpty(id))
    ...
    /// <param name="guid">The unique identifier to search for.</param>
    /// <returns><see langword="true" /> if a matching hint exists; otherwise <see langword="false" />.</returns>
    public static bool HasHint(this Player player, Guid guid)
    {
        return PlayerDisplay.Get(player).InternalGetHints(Assembly.GetCallingAssembly().FullName, hint => hint.Guid == guid).Any();
    }
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="id" /> is <see langword="null" />.</exception>
    /// <exception cref="ArgumentException">Thrown when <paramref name="id" /> is an empty string.</exception>
    public static bool TryGetHints(this Player player, string? id, out IEnumerable<AbstractHint> hints)
    {
        if (string.IsNullOrEmpty(id))
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="id" /> is an empty string.</exception>
#nullable disable
    public static bool TryGetHint(this Player player, string id, out AbstractHint hint)
    {
        if (string.IsNullOrEmpty(id))
    ...
    /// <summary>
    ///     Attempts to retrieve the first hint registered by the calling assembly that matches the specified
    ///     <see cref="Guid" />.
    /// </summary>
    /// <param name="player">The LabApi player whose hint is acquired from.</param>
    /// <param name="guid">The unique identifier to search for.</param>
    /// <param name="hint">When this method returns, contains the matching hint, or <see langword="null" /> if none was found.</param>
    /// <returns><see langword="true" /> if a matching hint was found; otherwise <see langword="false" />.</returns>
    public static bool TryGetHint(this Player player, Guid guid, out AbstractHint hint)
    {
