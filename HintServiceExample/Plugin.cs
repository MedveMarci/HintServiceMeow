...
/// <summary>
///     This is an example of how to create a simple ui for players using Hint and PlayerDisplay.
/// </summary>
public class Plugin : LabApi.Loader.Features.Plugins.Plugin
{
    ...
    public override Version RequiredApiVersion { get; } = Version.Parse(LabApiProperties.CompiledVersion);

    public override void Enable()
    {
        PlayerEvents.Joined += EventHandler.OnVerified;
